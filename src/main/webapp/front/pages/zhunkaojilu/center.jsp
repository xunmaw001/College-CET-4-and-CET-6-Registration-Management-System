					...
					<form class="layui-form" lay-filter="myForm">
						...
						<input type="hidden" name="id" id="id" />
							...
							<div class="layui-input-block">
								<input type="text" name="kaoshibianhao" id="kaoshibianhao" placeholder="考试编号" autocomplete="off" class="layui-input">
							</div>
						</div>
                                                                                                <div class="layui-form-item">
							<label class="layui-form-label">项目名称</label>
							<div class="layui-input-block">
								<input type="text" name="xiangmumingcheng" id="xiangmumingcheng" placeholder="项目名称" autocomplete="off" class="layui-input">
							</div>
						</div>
                                                                                                <div class="layui-form-item">
							...
							<div class="layui-input-block">
								<input type="text" name="kaoshishijian" id="kaoshishijian" placeholder="考试时间" autocomplete="off" class="layui-input">
							</div>
						</div>
                                                                                                <div class="layui-form-item">
							<label class="layui-form-label">考试地点</label>
							<div class="layui-input-block">
								<input type="text" name="kaoshididian" id="kaoshididian" placeholder="考试地点" autocomplete="off" class="layui-input">
							</div>
						</div>
                                                                                                <div class="layui-form-item">
							...
							<div class="layui-input-block">
								<input type="text" name="zhunkaozhenghao" id="zhunkaozhenghao" placeholder="准考证号" autocomplete="off" class="layui-input">
							</div>
						</div>
