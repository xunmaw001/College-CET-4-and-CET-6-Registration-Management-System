...
<body>
		...
		<div id="content">
				...
				<div class="container mt-0">
					<div class="row breadcrumb-bar">
						<div class="col-md-6">
							<h3 class="block-title">身份证认证管理</h3>
						</div>
						<div class="col-md-6">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item active"><span>身份证认证列表</span></li>
							</ol>
						</div>
					</div>
				</div>
				...
				<div class="row">
					...
					<div class="col-md-12">
						<div class="widget-area-2 lochana-box-shadow">
							<h3 class="widget-title">身份证认证列表</h3>							
	...
	<script>
        ...
        function getDataList() {
			http("shenfenzhengrenzheng/page","GET",{
				page: pageIndex,
				limit: pageSize,
				sort: sortColumn,
				order: sortOrder,
		...
		function setDataRow(item,number){
			...
			var shenfenzhengzhengmianzhaoCell  = document.createElement('td');

				                var shenfenzhengzhengmianzhaoImg = document.createElement('img');
			shenfenzhengzhengmianzhaoImg.setAttribute('src',item.shenfenzhengzhengmianzhao);
			shenfenzhengzhengmianzhaoImg.setAttribute('height',100);
			shenfenzhengzhengmianzhaoImg.setAttribute('width',100);
			shenfenzhengzhengmianzhaoCell.appendChild(shenfenzhengzhengmianzhaoImg);


			row.appendChild(shenfenzhengzhengmianzhaoCell);
			var shenfenzhengbeimianzhaoCell  = document.createElement('td');

				                var shenfenzhengbeimianzhaoImg = document.createElement('img');
			shenfenzhengbeimianzhaoImg.setAttribute('src',item.shenfenzhengbeimianzhao);
			shenfenzhengbeimianzhaoImg.setAttribute('height',100);
			shenfenzhengbeimianzhaoImg.setAttribute('width',100);
			shenfenzhengbeimianzhaoCell.appendChild(shenfenzhengbeimianzhaoImg);


			row.appendChild(shenfenzhengbeimianzhaoCell);
		...
		function sh(){
			...
			httpJson("shenfenzhengrenzheng/update","POST",data,(res)=>{
				if(res.code == 0){
					$('#addRowModal').hide();
					alert("提交成功");
        ...
        function remove(id) { 
            ...
            if (mymessage == true) {
				...
				httpJson("shenfenzhengrenzheng/delete","POST",paramArray,(res)=>{
					if(res.code == 0){
						getDataList();		
						alert('删除成功');
					}
		...
		function crossTable(id,crossTableName){
			...
			window.sessionStorage.setItem('crossTableName',"shenfenzhengrenzheng");
