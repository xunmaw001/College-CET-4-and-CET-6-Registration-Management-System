...
<body>
		...
		<div id="content">
				...
				<div class="container mt-0">
					<div class="row breadcrumb-bar">
						<div class="col-md-6">
							<h3 class="block-title">报名记录管理</h3>
						</div>
						<div class="col-md-6">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item"><span>报名记录管理</span></li>
								<li class="breadcrumb-item active"><span>报名记录列表</span></li>
							</ol>
						</div>
					</div>
				</div>
				...
				<div class="row">
					...
					<div class="col-md-12">
						<div class="widget-area-2 lochana-box-shadow">
							<h3 class="widget-title">报名记录列表</h3>							
							<div class="table-responsive mb-3" id="tableDiv">
								<div class="col-sm-12">
									<label>
										考试编号
									</label>
									<input type="text" id="kaoshibianhaoSearch" class="form-control form-control-sm" placeholder="" aria-controls="tableId">
									<label>
										学号
									</label>
								...
								<table id="tableId" class="table table-bordered table-striped">
									<thead>
										<tr>
											...
											<th onclick="sort('kaoshibianhao')">考试编号<i id="kaoshibianhaoIcon" class="fa fa-sort"></i></th>
											...
											<th onclick="sort('baokaojiage')">报考价格<i id="baokaojiageIcon" class="fa fa-sort"></i></th>
	...
	<script>
		...
		function search(){
			searchForm = { key: ""};
			if($('#kaoshibianhaoSearch').val() != null && $('#kaoshibianhaoSearch').val() != ''){
				searchForm.kaoshibianhao ="%" +  $('#kaoshibianhaoSearch').val() + "%";
			}
        ...
        function getDataList() {
			http("baomingjilu/page","GET",{
				page: pageIndex,
				limit: pageSize,
				sort: sortColumn,
				order: sortOrder,
				kaoshibianhao : searchForm.kaoshibianhao,	
		...
		function setDataRow(item,number){
			...
			var kaoshibianhaoCell  = document.createElement('td');

						 kaoshibianhaoCell.innerHTML = item.kaoshibianhao;


			row.appendChild(kaoshibianhaoCell);
			...
			var baokaojiageCell  = document.createElement('td');

						 baokaojiageCell.innerHTML = item.baokaojiage;


			row.appendChild(baokaojiageCell);
            ...
            crossBtn1.innerHTML = "分配准考号"
			crossBtn1.setAttribute("type","button");
			crossBtn1.setAttribute("class","btn btn-primary btn-sm");
			crossBtn1.setAttribute("onclick","crossTable(" + item.id + ",\"zhunkaojilu\")");
			if(crossBtnControl('分配准考号') == true){
		...
		function shDialog(id){
			$("#shId").attr("value",id);
			http("baomingjilu/info/" + id,"GET",{},(res)=>{
				if(res.code == 0){
		...
		function sh(){
			...
			httpJson("baomingjilu/update","POST",data,(res)=>{
				if(res.code == 0){
					$('#addRowModal').hide();
					alert("提交成功");
        ...
        function remove(id) { 
            ...
            if (mymessage == true) {
				...
				httpJson("baomingjilu/delete","POST",paramArray,(res)=>{
					if(res.code == 0){
						getDataList();		
						alert('删除成功');
					}
		...
		function crossTable(id,crossTableName){
			...
			window.sessionStorage.setItem('crossTableName',"baomingjilu");
        ...
        function pay(id){
			...
			window.sessionStorage.setItem('tableName',"baomingjilu");
