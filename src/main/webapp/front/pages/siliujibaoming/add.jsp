		...
		<div id="app">
			...
			<div class="data-add-container">
				...
				<form class="layui-form layui-form-pane" lay-filter="myForm">
						...
						<div class="layui-input-block">
							<input type="text" name="kaoshishijian" id="kaoshishijian" autocomplete="off" class="layui-input">
						</div>
					</div>
                                                                                <div class="layui-form-item" pane>
						...
						<div class="layui-input-block">
							<textarea name="xiangmushuoming" id="xiangmushuoming">请输入项目说明</textarea>
						</div>
					</div>
				...
				form.on('submit(*)', function(data) {
                    ...
                    // 数据校验
                        ...
                        return false
                                                                                                                                                                					                                                                                                                                                                					...
                                                                                                                                                                					                                                                                                                                                                					var xiangmushuoming = tinymce.get('#xiangmushuoming').getContent()
					data.xiangmushuoming = xiangmushuoming;
					...
					// 提交数据
					http.requestJson('siliujibaoming' + '/add', 'post', data, function(res) {
					 	layer.msg('提交成功', {
					 		time: 2000,
					 		icon: 6
					 	}, function() {
