...
<body>
  <div id="app">
    ...
    <div class="part2" style="margin-top: 50px;">
      <div class="part2_1">
        ...
        <div class="more">
            <a href="#" @click="jump('../siliujibaoming/list.jsp')">MORE>></a>
        </div>
      </div>
      <div class="part2_2">
        <div class="caseBox" v-for="(item,index) in siliujibaomingList" v-bind:key="index">
          <div class="caseBox_1">
          ...
          <div class="caseBox_2">
            <a :href="'../siliujibaoming/detail.jsp?id='+item.id">{{item.xiangmumingcheng}}<span style="color: red;float: right;" v-if="item.price">{{item.price}} RMB</span></a>
          </div>
        </div>
      </div>
    </div>
  ...
  <script>
    ...
    layui.use(['layer', 'form', 'element', 'carousel', 'http', 'jquery'], function() {
      ...
      http.request(`siliujibaoming/list`, 'get', {
        page: 1,
        limit: 6
      }, function(res) {
        vue.siliujibaomingList = res.data.list;
      });
    });
  </script>
</body>
